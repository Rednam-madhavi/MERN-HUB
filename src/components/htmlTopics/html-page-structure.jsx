...
<body>
    ...
    const renderCodeBlock = (id, code) => (
        <div className="relative my-6">
            <pre className="bg-gray-100 dark:bg-gray-800 text-[0.95rem] leading-relaxed p-4 rounded-md overflow-x-auto border border-gray-300 dark:border-gray-700 shadow-sm font-mono whitespace-pre-wrap">
                {code}
            </pre>
            <button
    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 text-gray-800 dark:text-gray-100">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-center">Understanding HTML Document Structure</h1>
            ...
            <div className="space-y-6">
                <p className="text-base"><strong>Note:</strong> Essential HTML tags: <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">&lt;!DOCTYPE html&gt;</code>, <code>&lt;html&gt;</code>, <code>&lt;head&gt;</code>, <code>&lt;title&gt;</code>, <code>&lt;/head&gt;</code>, <code>&lt;body&gt;</code>, <code>&lt;/body&gt;</code>, <code>&lt;/html&gt;</code></p>
            ...
            <div>
                ...
                <img src={structure} alt="HTML Tag Structure" className="w-full max-w-xl mx-auto rounded-md shadow-md mt-4" />
            </div>
            ...
            <div>
                ...
                <img src={output} alt="HTML Output Preview" className="w-full max-w-xl mx-auto rounded-md shadow-md mt-4" />
