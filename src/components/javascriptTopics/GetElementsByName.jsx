...
const GetElementsByName = () => {
    ...
    const handleCopy = () => {
        clipboard.copy(`let elements = document.getElementsByName("myName");
    ...
    return (
        <div className="w-full max-w-screen-lg mx-auto px-4 sm:px-6 md:px-8 py-6 space-y-6 text-gray-800 dark:text-gray-100">
            ...
            <div className="space-y-2">
                ...
                <pre className="bg-gray-100 dark:bg-gray-700 text-sm sm:text-base p-4 rounded border border-gray-300 dark:border-gray-600 overflow-x-auto">
